...
/* resources/js/Pages/Index.svelte generated by Svelte v3.47.0 */


function add_css(target) {
  (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_styles)(target, "svelte-bb2z5z", "h1.svelte-bb2z5z{color:indigo;font-family:'Calibri', cursive;font-size:3em}");
}
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      h1.textContent = "Svelte greets ".concat(name, " through inertia");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(h1, "class", "svelte-bb2z5z");
    },
    m: function m(target, anchor) {
